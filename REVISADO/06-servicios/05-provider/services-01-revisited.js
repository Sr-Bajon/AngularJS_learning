/*
  Con los provider podemos establecer configuraciones antes de que cargue la
  aplicacion.
 */
...
angular.module('notesApp', [])
  .provider('ItemService', function () {
    // provider no puede tener dependencias de otros servicios declarado en su
    // inicializacion
  ...
  .config(['ItemServiceProvider',
    // config se ejecuta antes que controladores, servicios y otras funciones
    // en el config tambien podemos establecer endpoints para la URL,
    // informacion local, configuracion de routing, etc.
